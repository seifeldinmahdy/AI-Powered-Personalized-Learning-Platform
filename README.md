...
| **Live 1-on-1 Voice Sessions** | Real-time, voice-based interaction (ASR/TTS) between student and AI tutor.
| **Synchronized Slides** | AI generates and displays structured learning slides, changing them contextually.
| **Embedded Code Editor** | Interactive coding environment with real-time evaluation and safe moderation.
