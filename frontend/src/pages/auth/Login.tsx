...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (state?.from) {
      ...
      // Route based on role (admin emails go to admin dashboard)
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-[#4C6FFF] to-[#A78BFA] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 group"
                >
              ...
              <div className="mt-6 p-4 bg-[#F0F4FF] rounded-xl border border-[#E0E7FF]">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-[#1F2937] mb-1">Demo Mode</p>
                    <p className="text-xs text-[#6B7280] leading-relaxed">
                      Use any email/password to sign in.
                      Include <strong>"admin"</strong> in the email (e.g.{" "}
                      <code className="text-[#4C6FFF]">admin@test.com</code>) for the Admin
                      view, or any other email for the Student view.
                    </p>
                  </div>
                </div>
              </div>
