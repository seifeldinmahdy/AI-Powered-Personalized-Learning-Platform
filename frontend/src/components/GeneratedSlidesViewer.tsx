...
export function GeneratedSlidesViewer({
  ...
  return (
    <div className="flex-1 flex flex-col bg-background relative">
      <div
        className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-muted/20 to-background"
        style={isFullscreen ? { paddingLeft: 360 } : undefined}
      >
        {/* Left arrow */}
        <button
          onClick={handlePrev}
        ...
        <button
          onClick={handleNext}
          className="absolute right-4 z-10 p-2 rounded-full bg-card/80 border border-border shadow-md hover:bg-card hover:border-secondary transition-all"
          style={isFullscreen ? undefined : { right: '340px' }}
          title="Next slide"
        >
